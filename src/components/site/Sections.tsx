...
export function Hero({ onDiagnostico }: { onDiagnostico: () => void }) {
  return (
    <section id="top" className="relative min-h-screen flex items-center justify-center pt-24 pb-20 lg:pb-24 overflow-hidden bg-grid-tech">
...
export function Pains() {
  return (
    <section className="relative py-18 md:py-24 bg-grid-ambient">
      ...
      <div className="container-aceleriq">
        ...
        <div className="mt-10 md:mt-12 grid gap-px overflow-hidden rounded-2xl border border-border bg-border md:grid-cols-2 lg:grid-cols-3">
          {PAINS.map((p, i) => (
            <motion.div
              key={p.title}
...
export function About() {
  return (
    <section className="relative py-18 md:py-24 overflow-hidden bg-grid-ambient">
      ...
      <div className="container-aceleriq">
        <div className="grid gap-8 lg:grid-cols-12 lg:items-start">
          ...
          >
            ...
            <div className="divider-neon mt-7" />
...
export function Method() {
  return (
    <section
      id="metodo"
      className="relative py-18 md:py-24 overflow-hidden bg-grid-ambient"
    >
    ...
    <section className="relative py-18 md:py-24 overflow-hidden bg-grid-ambient">
      ...
      <div className="container-aceleriq relative">
        ...
        <motion.div
          ...
          viewport={{ once: true, margin: "-80px" }}
          transition={{ duration: 0.5 }}
          className="mt-10 md:mt-12 overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-white/[0.03] to-transparent shadow-[0_30px_80px_-30px_oklch(0%_0_0/0.6)]"
        >
          {/* Cabeçalho da tabela */}
...
export function DiagnosticoCTA({ onDiagnostico }: { onDiagnostico: () => void }) {
  return (
    <section id="diagnostico" className="relative py-18 md:py-24 bg-grid-ambient">
      <div className="container-aceleriq">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          <div className="relative grid gap-8 p-7 md:p-10 lg:grid-cols-[1.1fr_1fr] lg:items-center">
            <div>
...
export function Results() {
  return (
    <section id="resultados" className="relative py-18 md:py-24 bg-grid-ambient">
      <div className="container-aceleriq">
        <SectionHeader
        ...
        <div className="mt-10 md:mt-12 grid gap-px overflow-hidden rounded-2xl border border-border bg-border sm:grid-cols-2 lg:grid-cols-4">
          {METRICS.map((m, i) => (
            <motion.div
              key={m.label}
  ...
  return (
    <section className="relative py-18 md:py-24 bg-grid-ambient">
      <div className="container-aceleriq">
        ...
        <div className="mt-10 md:mt-12 grid gap-3 md:grid-cols-3">
    ...
    <section className="relative py-18 md:py-24 bg-grid-ambient">
      <div className="container-aceleriq">
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.5 }}
          className="relative overflow-hidden rounded-3xl border border-border bg-card/40 p-7 md:p-10"
        >
...
export function FAQ() {
  return (
    <section id="faq" className="relative py-18 md:py-24 bg-grid-ambient">
      <div className="container-aceleriq">
        <SectionHeader
