...
export function MacBookHero() {
  return (
    <div className="relative mx-auto w-full max-w-[1120px] px-2 py-4 md:px-6 md:py-8">
      <div
        aria-hidden
        className="absolute left-1/2 top-1/2 h-[52%] w-[86%] -translate-x-1/2 -translate-y-1/2 rounded-[100%] bg-primary/20 blur-3xl"
      />
      <div
        aria-hidden
        className="absolute left-1/2 top-[58%] h-[18%] w-[72%] -translate-x-1/2 rounded-[100%] bg-foreground/10 blur-2xl"
      />
        ...
        <div className="relative mx-auto aspect-[16/10] w-full max-w-[980px] [transform:rotateX(5deg)_rotateY(-4deg)] [transform-style:preserve-3d]">
          <div className="absolute left-[6%] right-[6%] top-[2%] z-20 aspect-[16/10] rounded-t-[24px] border border-foreground/10 bg-gradient-to-b from-foreground/95 via-foreground/80 to-foreground/55 p-[1.15%] shadow-[0_52px_130px_-70px_oklch(0%_0_0/1)]">
            <div className="relative h-full overflow-hidden rounded-t-[18px] border border-border/70 bg-background">
              ...
              <div
                aria-hidden
                className="absolute inset-0 bg-gradient-to-tr from-transparent via-foreground/10 to-transparent opacity-60"
              />
          ...
          <div className="col-span-7 flex flex-col justify-between">
            ...
            <div className="grid grid-cols-3 gap-[3%]">
              {metrics.map((metric) => (
                <div
                  key={metric.label}
                  className="border border-border/80 bg-foreground/[0.03] p-[8%]"
                >
                  <div className="font-mono text-[clamp(6px,0.65vw,9px)] uppercase tracking-[0.16em] text-muted-foreground">
                    {metric.label}
                  </div>
                  <div className="mt-[8%] font-display text-[clamp(14px,2vw,28px)] font-semibold leading-none tracking-normal">
                    {metric.value}
                  </div>
                  <div className="mt-[8%] text-[clamp(6px,0.72vw,10px)] text-primary">
                    {metric.detail}
                  </div>
                </div>
              ))}
          ...
          <div className="col-span-5 grid grid-rows-[1fr_0.72fr] gap-[5%]">
            <div className="relative overflow-hidden border border-primary/25 bg-primary/[0.06] p-[6%]">
              ...
              <div className="relative h-full">
                <div className="mb-[7%] font-mono text-[clamp(6px,0.7vw,10px)] uppercase tracking-[0.18em] text-primary">
                  funil em tempo real
                </div>
            ...
            <div className="border border-border/80 bg-foreground/[0.03] p-[6%]">
              <div className="font-mono text-[clamp(6px,0.7vw,10px)] uppercase tracking-[0.18em] text-muted-foreground">
                status
              </div>
