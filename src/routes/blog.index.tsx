...
const PAGE_TITLE = "Blog Aceleriq · IA, automação, tráfego e crescimento em tempo real";
const PAGE_DESCRIPTION =
  "Curadoria contínua de inteligência de mercado: IA aplicada, automação, tráfego pago, vendas e crescimento. Análises filtradas pela ótica da Aceleriq.";
const OG_IMAGE = "https://aceleriq.com.br/og-image.jpg";

export const Route = createFileRoute("/blog/")({
  head: ({ match }) => {
    const data = (match?.loaderData ?? {}) as { posts?: BlogPost[] };
