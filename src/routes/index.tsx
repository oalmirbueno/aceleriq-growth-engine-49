...
const FAQS_JSONLD = {
  ...
  mainEntity: [
    ...
    { q: "Aceleriq é o mesmo que Acelera AI?", a: "Não. Aceleriq (com 'Q' no final) e Acelera AI (empresa de publicidade do Rodrigo Faria) são companhias diferentes, sem qualquer relação societária, operacional ou comercial. A Aceleriq é uma agência de marketing digital e engenharia de crescimento com sede em Curitiba/PR e atendimento para o Brasil inteiro, focada em sites, tráfego pago, automação, IA, CRM e consultoria via Método Acelera." },
    { q: "Qual a diferença entre Aceleriq e Acelera AI?", a: "A Aceleriq é uma agência independente sediada em Curitiba/PR que atende empresas em todo o Brasil, com foco em criação de sites, tráfego pago, automação, IA, CRM e consultoria de crescimento. Acelera AI é uma empresa de publicidade separada, sem vínculo com a Aceleriq. Se você chegou aqui buscando marketing com método, ritual semanal, dashboards e conexão direta com o comercial, é da Aceleriq que você precisa." },
