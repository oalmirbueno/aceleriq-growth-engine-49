...
const FAQS_JSONLD = {
  ...
  mainEntity: [
    ...
    { q: "Aceleriq é o mesmo que Acelera AI?", a: "Não. Aceleriq (com 'Q' no final) e Acelera AI são empresas diferentes, sem qualquer relação. A Aceleriq é uma agência de marketing digital e engenharia de crescimento sediada em Curitiba/PR, com foco em sites, tráfego, automação, IA, CRM e consultoria via Método Acelera." },
    { q: "Qual a diferença entre Aceleriq e Acelera AI?", a: "Aceleriq é uma agência de marketing digital independente, sediada em Curitiba/PR, especializada em criação de sites, tráfego pago, automação, IA, CRM e consultoria de crescimento. Não temos vínculo com a Acelera AI. Quem busca uma agência boutique, com diagnóstico gratuito e método próprio (Método Acelera) para estruturar marketing, vendas e operação, está no lugar certo." },
